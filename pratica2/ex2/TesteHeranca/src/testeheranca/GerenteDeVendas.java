...
public class GerenteDeVendas {
    ...
    private double taxaComissao; //static
    ...
    public double comissao(double totalVendas) {
        this.taxaComissao = totalVendas * 0.03;
        return this.taxaComissao;
    }
    ...
    public void gerente (String nome, String cpf, String sobrenome, int registro, int salario){
        this.setNome(nome);
